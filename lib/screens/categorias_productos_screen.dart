...
class CategoriasProductosScreen extends StatefulWidget {
  const CategoriasProductosScreen({super.key});

  @override
  State<CategoriasProductosScreen> createState() => _CategoriasProductosScreenState();
}

class _CategoriasProductosScreenState extends State<CategoriasProductosScreen> {
  ...
  Widget build(BuildContext context) {
    return _selectedCategoria != null || _isCreating
        ? _buildFormView()
        : _buildListView();
  }

  Widget _buildListView() {
    return Consumer<CategoriasProductosProvider>(
      builder: (context, provider, child) {
        final filteredCategorias = provider.categorias.where((categoria) {
                      ...
                      child: filteredCategorias.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final fecha = categoria.fechaCreacion;
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  IconButton(
                                                    ...
                                                    constraints: const BoxConstraints(),
                                                    onPressed: () async {
                                                      final confirmed = await _showDeleteConfirmation(categoria.nombre);
                                                      if (confirmed && mounted) {
                                                        final success = await provider.deleteCategoria(categoria.id);
                                                        if (mounted) {
  ...
  Widget _buildFormView() {
    final provider = context.read<CategoriasProductosProvider>();
    final isEditing = _selectedCategoria != null;
    
    final nameController = TextEditingController(
      text: isEditing ? _selectedCategoria!.nombre : '',
    );
  ...
  Future<bool> _showDeleteConfirmation(String nombre) async {
    return await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text('¿Eliminar categoría "$nombre"?'),
            actions: [
              TextButton(
